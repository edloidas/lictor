...
import { type FatalAction, supervisor } from './supervision.ts';
...
export const supervisedMaintenanceLoop = (fatal: FatalAction) =>
  supervisor(fatal)('daemon maintenance loop', 'never', maintenanceLoop);
